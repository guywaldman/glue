// ------------------------------------
// Generated by Glue on 2026-06-14
...
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, Default)]
pub struct GlueConfigSchemaGlobalDiagnostics {
...
pub struct GlueConfigSchemaGlobal {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub diagnostics: Option<GlueConfigSchemaGlobalDiagnostics>,
...
pub struct GlueConfigSchemaGenConfig {
    ...
    pub files: GlueConfigSchemaGenConfigFiles,
...
pub struct GlueConfigSchemaGeneration {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub preserve_generated_identifiers: Option<bool>,
...
#[serde(untagged)]
pub enum GlueConfigSchemaGenConfigFiles {
    String(String),
    StringArray(Vec<String>),
}

impl Default for GlueConfigSchemaGenConfigFiles {
    fn default() -> Self {
