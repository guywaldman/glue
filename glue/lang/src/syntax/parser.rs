...
impl Parser {
    ...
    fn map_rule(r: Rule) -> LSyntaxKind {
        ...
        match r {
            ...
            Rule::import_stmt => IMPORT_STMT,
            Rule::import_items => IMPORT_ITEMS,
            Rule::import_wildcard => IMPORT_WILDCARD,
