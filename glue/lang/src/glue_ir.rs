...
impl GlueIrNodeKind {
    fn from_lsyntax(kind: LSyntaxKind) -> Self {
        match kind {
            ...
            LSyntaxKind::SERVICE => Self::Service,
            LSyntaxKind::RPC => Self::Rpc,
            LSyntaxKind::ENUM => Self::Enum,
            LSyntaxKind::TYPE_ALIAS => Self::TypeAlias,
            LSyntaxKind::CONST_DEF => Self::ConstDef,
            LSyntaxKind::CONST_EXPR => Self::ConstExpr,
            LSyntaxKind::CONST_ADD => Self::ConstAdd,
            LSyntaxKind::CONST_MUL => Self::ConstMul,
            LSyntaxKind::CONST_PRIMARY => Self::ConstPrimary,
            LSyntaxKind::CONST_REF => Self::ConstRef,
    ...
    fn from_semantic_token(kind: LSyntaxKind) -> Option<Self> {
        match kind {
            ...
            LSyntaxKind::CONST_IDENT => Some(Self::ConstIdent),
            ...
            LSyntaxKind::TUPLE => Some(Self::Tuple),
